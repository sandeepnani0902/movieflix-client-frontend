      ...
      {open && (
        <div className="absolute top-12 md:top-14 left-0 w-full bg-white rounded-lg shadow-xl border border-slate-200 z-50 overflow-hidden">
          {options.map((item) => (
            <div
              key={item}
              className="px-4 py-3 text-sm md:text-base text-slate-700 hover:bg-red-750 hover:bg-red-700 hover:text-white cursor-pointer transition-colors font-medium"
