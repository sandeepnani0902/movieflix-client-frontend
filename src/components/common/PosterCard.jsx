...
const PosterCard = ({ movie = [], isWebSeries = false }) => {
      ...
      <div className="bg-zinc-900 rounded-xl overflow-hidden shadow-lg group">
        ...
        <div className="p-3">
          ...
          <button
            ...
            className="bg-red-900 hover:bg-red-600 transition px-4 py-2 rounded-lg text-white text-sm font-medium cursor-pointer"
          >
            Watch Now
          </button>
        </div>
